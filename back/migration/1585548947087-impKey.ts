...
export class impKey1585548947087 implements MigrationInterface {
    name = 'impKey1585548947087'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `user_entity` ADD `impIdentityKey` varchar(320) NOT NULL", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `user_entity` DROP COLUMN `impIdentityKey`", undefined);
    }
