...
export class buildModels1585555320295 implements MigrationInterface {
    name = 'buildModels1585555320295'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `user_entity` (`id` int NOT NULL AUTO_INCREMENT, `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `username` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, `email` varchar(255) NOT NULL, `name` varchar(20) NOT NULL, `phone` varchar(40) NOT NULL, `impIdentityKey` varchar(320) NOT NULL, `adminLevel` smallint NOT NULL DEFAULT 0, `level` int NOT NULL DEFAULT 0, `type` enum ('member', 'partner') NOT NULL DEFAULT 'member', `allowSMS` tinyint NOT NULL DEFAULT 1, `allowPush` tinyint NOT NULL DEFAULT 1, `balance` int UNSIGNED NOT NULL DEFAULT 0, `landingPage` mediumtext NOT NULL, `active` tinyint NOT NULL DEFAULT 1, `addressId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
